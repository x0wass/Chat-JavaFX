...
public class Main extends Application
{
	...
	public void start(Stage primaryStage)
	{
		...
		{
			/*
			 * DONE Complete ClientFrame.fxml with SceneBuilder until
		...
		/*
		 * DONE Uncomment the following lines, once you've checked GUI
		 * can be launched : See Finally launch GUI line 268
		 */
		// --------------------------------------------------------------------
		...
		/*
		 * DONE Complete controller's setup ...
		 */
